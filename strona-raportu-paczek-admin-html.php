...
<form action="https://www.zdrowewarzywka.pl/wp-admin/admin.php?page=raport" method="POST" name="theForm" id="theForm">
	...
	else
	{
		...
		foreach($daty as $date){
			...
			{	
				...
				echo packages_report($date);	
				echo '<br>';
				echo orders_report($date);
